 ...
 */
	...
	public function toHtmlTableRow($imagePath, $action='editform') {
		...
		<tr>
			<td>
				<a href="./?action=$action&subaction=moveUp&elementid={$this->elementId}">
					<img src="$imagePath/common/icons/16x16/actions/go-up.png" alt="Move Up" title="Move Up"/>
				</a>
			
				<a href="./?action=$action&subaction=moveDown&elementid={$this->elementId}">
					<img src="$imagePath/common/icons/16x16/actions/go-down.png" alt="Move Down" title="Move Down"/>
				</a>
			
				<a href="./?action=$action&subaction=editformelement&elementid={$this->elementId}">
					<img src="$imagePath/common/icons/16x16/apps/accessories-text-editor.png" alt="Edit" title="Edit" />
				</a>
			
				<a style="cursor:pointer" onclick="return gotopage('./?action=$action&subaction=deleteformelement&elementid={$this->elementId}')">
...
ROWSTRING;
	...
	public function toHtmlForm($formHtmlId = 'elementDataForm', $action = 'editform') {
		...
		<form id="$formHtmlId" action="./?action=$action&subaction=editformelement" method="POST">
			<br />
