...
//TODO : If the form is associated with a group, the form HAS to give the user the option to unregister from it.
	...
	function generateFormDescBody($moduleCompId, $action = 'editform') {
		...
		global $templateFolder;global $moduleFolder;global $moduleCompId;
		...
		<form id="formdetails" action="./?action=$action" method="post" name="formDetails">
...
BODY;
	...
	function generateFormElementDescBody($moduleCompId, $action = 'editform') {
		...
		global $templateFolder;global $moduleFolder;global $moduleCompId;
		global $urlRequestRoot;
		$imagePath = "/festember/register/images";$calpath="$urlRequestRoot/$cmsFolder/$moduleFolder";
		...
		<h2>Fields:</h2>
		<form id="formentries" action="./?action=$action" method="POST">
